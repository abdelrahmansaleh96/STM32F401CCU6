...
RCC_tenumErrorStatus RCC_SelectSysClk(uint8_t Copy_u8SysClk)
{
	...
	{
		Loc_ErrorStatus = RCC_enumSWSerror;
...
RCC_tenumErrorStatus RCC_ControlHSIOn(void)
{
	...
	/*Read bit in RCC_CR*/
	Loc_ReadyRead = (RCC_BASE->RCC_CR & RCC_CR_HSERDY_GET_M);
...
RCC_tenumErrorStatus RCC_ControlHSIOff(void)
{
	...
	else if(!(RCC_BASE->RCC_PLLCFGR & RCC_PLLCFGR_SCR_GET_M))
	{
		Loc_ErrorStatus = RCC_enumSelectSysClkerror;
	}
	else
...
** Return:      RCC_tenumErrorStatus
******************************************************************************/
RCC_tenumErrorStatus RCC_ControPLLOff(void)
{
	RCC_tenumErrorStatus Loc_ErrorStatus = RCC_enumOK;
...
** Return:      RCC_tenumErrorStatus
******************************************************************************/
RCC_tenumErrorStatus RCC_EnablePriphralCLK(uint64_t Copy_PriphralMask)
{
